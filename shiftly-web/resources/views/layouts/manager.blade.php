...
<head>
    ...
    <style>
        ...
        .sidebar-manager .brand-title { color: #F1F5F9; font-weight: 700; }
        .sidebar-manager .brand-sub   { color: #64748B; font-size: 11px; }

        .sidebar-manager .nav-item {
            color: #94A3B8;
            font-size: 13px;
            font-weight: 500;
        ...
        .sidebar-manager .nav-item:hover {
            background: rgba(255,255,255,0.07);
            color: #F1F5F9;
        }
        .sidebar-manager .nav-item.active {
            background: rgba(27,110,245,0.25);
            color: #60A5FA;
            font-weight: 600;
            border-left: 3px solid #3B82F6;
            padding-left: calc(12px - 3px);
        }
        .sidebar-manager .role-badge {
        ...
        .sidebar-manager .logout-btn:hover { background: rgba(239,68,68,0.12); border-color: rgba(239,68,68,0.2); color: #F87171; }
...
<body>
    ...
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div class="sidebar-manager w-64 fixed h-full overflow-y-auto flex flex-col">
            <div class="p-6 flex flex-col h-full">

                {{-- Brand --}}
                <div class="flex items-center gap-3 mb-8">
                    <div class="icon-box flex-shrink-0" style="background: linear-gradient(135deg, #3B82F6 0%, #1D4ED8 100%);">
                ...
                <nav class="space-y-0.5 flex-1">
                    <a href="{{ route('manager.dashboard') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('manager.dashboard') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 13a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6z" /></svg>
                        <span>Dashboard</span>
                    </a>
                    <a href="{{ route('manager.employees.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('manager.employees.*') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                        <span>Employees</span>
                    </a>
                    <a href="{{ route('manager.departments.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('manager.departments.*') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                        <span>Departments</span>
                    </a>
                    <a href="{{ route('manager.shift-requirements.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('manager.shift-requirements.*') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        <span>Shift Requirements</span>
                    </a>
                    <a href="{{ route('manager.cluster.show') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('manager.cluster.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('manager.schedules.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('manager.schedules.index') || request()->routeIs('manager.schedules.show') ? 'active' : '' }}">
                ...
                {{-- User Info + Logout --}}
                <div class="mt-6 pt-6" style="border-top: 1px solid rgba(255,255,255,0.07);">
