...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 4px 12px rgba(27, 110, 245, 0.3);
        }
        ...
        <div class="sidebar w-64 fixed h-full overflow-y-auto">
            <div class="p-6">
                <div class="flex items-center gap-3 mb-10">
                    <div class="icon-box" style="background: linear-gradient(135deg, #1B6EF5 0%, #1558D6 100%);">
                        <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <div>
                        <div class="text-headline" style="font-weight: 700;">Shiftly</div>
                        <div class="text-caption">Hospital Scheduler</div>
                    </div>
                </div>
                ...
                <div class="mt-auto pt-8 border-t border-gray-100 mt-10">
                    <div class="px-3 py-3 bg-gray-50 rounded-lg mb-3">
                        <div class="text-caption mb-1">LOGGED IN</div>
                        <div class="text-body font-semibold truncate">{{ auth()->user()->name }}</div>
                        <div class="text-caption truncate">{{ auth()->user()->email }}</div>
                    </div>
